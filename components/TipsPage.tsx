...
import { IconShield, IconWallet, IconGlobe, IconFood, IconMapPin, IconInfo } from './icons';
...
export const TipsPage: React.FC<TipsPageProps> = ({ onGoHome, onOpenQue, onOpenWorld }) => {
  return (
